...
import guru.springframework.spring6di.controllers.MyControllerSpringWay;
...
public class LifeCycleDemoBean implements InitializingBean, DisposableBean, BeanNameAware,
    ...
    public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
        ...
        if (bean instanceof MyControllerSpringWay){
            System.out.println("## postProcessBeforeInitialization: " + beanName);
            System.out.println("inside??????****");
            MyControllerSpringWay myController = (MyControllerSpringWay) bean;
            System.out.println("Calling before init");
            myController.beforeInit();
        }
